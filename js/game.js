// game.js — styled & functional with sprite support and viewport-scaled tiles
...
function renderLevel() {
  ...
  const vhUnit = 90 / rows; // leave a bit of space for header
  gameEl.style.gridTemplateColumns = `repeat(${cols}, ${vhUnit}vh)`;
  gameEl.style.gridAutoRows = `${vhUnit}vh`;
